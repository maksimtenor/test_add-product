...
var downs = $('.productCard--item').sort(function (a, b) {
 ...
 var ups = $('.productCard--item').sort(function (a, b) {
...
$('#productCard__sort').on('change', function(){
    ...
    if(this.options[this.selectedIndex].value == '1') {
        return downs.appendTo($('.block__productCard_items'));
    }
    if(this.options[this.selectedIndex].value == '2') {
        return ups.appendTo($('.block__productCard_items'));
    }
